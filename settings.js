...
// (The old `logging` boolean did nothing - log_level is always set by the
// built-in defaults, so the boolean's branch was never reachable.)
// The LOG_LEVEL environment variable raises the components this setting does
// not reach, such as the C-Gate connection and MQTT layers.
...
// Path to a JSON label file (generated by: node tools/import-cbus-labels.js project.cbz)
// Provides custom names for C-Bus groups during HA Discovery.
// Labels in this file take priority over C-Gate TREEXML labels.
// The file is watched for changes and hot-reloaded automatically.
// exports.cbus_label_file = './labels.json';

// --- Web Interface Settings ---
// Port for the label editor web UI (also used by HA addon ingress)
